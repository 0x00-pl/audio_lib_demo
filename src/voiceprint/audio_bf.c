...
{
	audio_bf->bf_dir_bidx[dir_num][0] =
	...
	audio_bf->bf_dir_bidx[dir_num][1] =
	(struct audio_bf_dir_bidx_t){
...
//	struct audio_bf_int_stat_t bf_int_stat_reg = audio_bf->bf_int_stat_reg;
//
//	printf("  audio_bf->bf_int_stat_reg = (struct audio_bf_int_stat_t){\n");
//	printf("    .dir_search_data_rdy = %d, .voc_buf_data_rdy = %d\n",
//	       bf_int_stat_reg.dir_search_data_rdy, bf_int_stat_reg.voc_buf_data_rdy);
//	printf("  };\n");
