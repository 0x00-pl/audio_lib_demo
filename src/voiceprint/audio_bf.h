...
extern volatile struct audio_bf_reg_t *const audio_bf; // = (volatile struct audio_bf_reg_t *)BEAFORMING_BASE_ADDR;
...
void audio_bf_set_down_size(uint8_t dir_dwn_siz, uint8_t voc_dwn_siz); //split to 2 functions
void audio_bf_set_interrupt_mask(uint8_t dir_int_mask, uint8_t voc_int_mask); //split to 2 functions
